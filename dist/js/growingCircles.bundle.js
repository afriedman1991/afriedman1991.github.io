...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/growingCircles.js");
/******/ })
/************************************************************************/
/******/ ({
...
var maxRadius = 40;
var minRadius = 2;
var colors = ['#2C3E50', '#E74C3C', '#ECF0F1', '#3498DB', '#2980B9']; // Animation

var Circle = /*#__PURE__*/function (_Object) {
  _inherits(Circle, _Object);
  ...
  function Circle(x, y, dx, dy, radius) {
    ...
    _this = _super.call(this, x, y, dx, dy, radius);
    _this.x = x;
    _this.y = y;
    _this.dx = dx;
    _this.dy = dy;
    _this.radius = radius;
    _this.minRadius = radius;
...
/******/ });
//# sourceMappingURL=growingCircles.bundle.js.map